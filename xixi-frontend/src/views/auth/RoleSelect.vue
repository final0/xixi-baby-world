<template>
  <div class="role-page">
    <div class="role-card">
      ...
      <el-button type="primary" size="large" :disabled="!selected" :loading="loading" @click="handleConfirm" style="width:100%;margin-top:24px">
        确认，进入汐汐的小窝！🌸
      </el-button>
    </div>
  </div>
...
async function handleConfirm() {
  loading.value = true
  try {
    await selectRole(selected.value)
